    ...
    messages: [
      {
        role: "user",
        content:
          "Summarize the given sentances or condense them that I'll be giving you in upcoming prompts such that I can use them as notes in my note taking application (the result should be 'response' don't add any commentary from the llm)",
      },
      {
        role: "assistant",
        content:
          "Sure, feel free to provide the sentences you'd like summarized or condensed, and I'll help you create concise notes from them, also making sure that you don't get any extra commentaries, errors or even suggestions.",
      },
      {
        role: "user",
        content:
          "Complete the homework of computer science, design the UI of application using tailwind and don't forget to bring groceries after uni (Don't give responses like No problem, here is a summarized version of your prompt: 'Today is Saturday.', I just want the final note content, don't show on the client side that you're an llm model)",
      },
      {
        role: "assistant",
        content:
          "'-Make sure to compelete computer assignment\n-Design UI of app using Tailwind CSS\n-Bring groceries after university'",
      },
      {
        role: "user",
